...
- `stagehand` - Stagehand 工具使用
- `superpowers` - Agent 超能力配置

## ⚡ 性能优化

**何时查阅**：系统响应慢、资源占用高、需要优化性能时

- `cache-penetration` - 缓存穿透问题
- `connection-pool` - 连接池管理
- `async-batch` - 异步批处理优化

## 🌐 分布式系统

**何时查阅**：设计分布式架构、处理分布式问题时
...
- `product-management` - RICE 框架、PRD 模板 ✅ 已使用

## 🔧 工具/技能

**何时查阅**：使用特定工具或技能时

- `tavily-search` - Tavily 搜索 API ✅ 已使用
- `text-summarization` - 文本摘要技术
- `wechat-feishu-skill` - 微信/飞书技能开发
- `spec-kit` - Spec 工具包
